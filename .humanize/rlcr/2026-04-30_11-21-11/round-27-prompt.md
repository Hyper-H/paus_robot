...
2026-04-30T19:34:04.374271Z ERROR codex_core::session: failed to record rollout items: thread 019ddfdd-3fcb-7df2-b7cd-10a44f827a32 not found
codex
The new semi-auto workflow cannot complete a successful motion-backed calibration because it rejects its own internal solve step. That blocks the primary new feature from producing or saving a solution.

Review comment:

- [P1] Let semi-auto runs call the solver while active — /home/chen_lab/worktrees/paus_robot_handeye_rlcr/src/paus_marker_ros2/paus_marker_ros2/eye_to_hand_calibration_node.py:627-628
  When `execute_motion=true` and a semi-auto run captures at least `min_sample_count` samples, `_run_semi_auto_callback()` calls `_solve_callback()` before clearing `_semi_auto_active`. This guard then treats the internal solve as a forbidden manual request and returns `"Semi-auto calibration is running; manual solve is disabled."`, so every real semi-auto calibration fails before solving or saving extrinsics.
2026-04-30T19:34:04.384117Z ERROR codex_core::session: failed to record rollout items: thread 019ddfdd-3fac-7ff3-835b-39ee9b1ee15c not found
The new semi-auto workflow cannot complete a successful motion-backed calibration because it rejects its own internal solve step. That blocks the primary new feature from producing or saving a solution.
...
5. **Write your summary** to: `/home/chen_lab/worktrees/paus_robot_handeye_rlcr/.humanize/rlcr/2026-04-30_11-21-11/round-27-summary.md`
