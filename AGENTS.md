...
- Before any task, inspect the lab repo:
  `ssh chen_lab@192.168.58.183 'cd /mnt/data/projects/paus_robot/repo && git status --short --branch && git branch --show-current'`
...
1. `ssh chen_lab@192.168.58.183 'cd /mnt/data/projects/paus_robot/repo && git fetch origin && git switch dev && git pull origin dev'`
2. `ssh chen_lab@192.168.58.183 'cd /mnt/data/projects/paus_robot/repo && git switch -c codex/<task>'`
