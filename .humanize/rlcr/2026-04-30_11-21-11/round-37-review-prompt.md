...
- **Base Branch**: main
- **Review Round**: 37
- **Timestamp**: 2026-05-01T06:13:45Z
...
- `round-37-review-prompt.md` - This audit file
- `round-37-review-result.md` - Review output (in loop directory)
- `round-37-codex-review.cmd` - Command invocation (in cache)
- `round-37-codex-review.out` - Stdout capture (in cache)
- `round-37-codex-review.log` - Stderr capture (in cache)
