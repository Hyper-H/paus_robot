...
- **Base Branch**: main
- **Review Round**: 20
- **Timestamp**: 2026-04-30T17:42:55Z
...
- `round-20-review-prompt.md` - This audit file
- `round-20-review-result.md` - Review output (in loop directory)
- `round-20-codex-review.cmd` - Command invocation (in cache)
- `round-20-codex-review.out` - Stdout capture (in cache)
- `round-20-codex-review.log` - Stderr capture (in cache)
